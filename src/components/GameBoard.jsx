...
import { SIZE, emptyGrid, addRandomTile, isGameOver, moveGrid } from "../utils/gameLogic";

export default function GameBoard({ account, contract, scoreSaved, setScoreSaved, connectWallet }) {
